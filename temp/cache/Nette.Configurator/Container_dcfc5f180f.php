<?php
// source: C:\xampp\htdocs\lekaren\app/config/config.neon 
// source: C:\xampp\htdocs\lekaren\app/config/config.local.neon 

class Container_dcfc5f180f extends Nette\DI\Container
{
	protected $meta = [
		'types' => [
	...
	{
		parent::__construct([
			'appDir' => 'C:\xampp\htdocs\lekaren\app',
			'wwwDir' => 'C:\xampp\htdocs\lekaren\www',
			'debugMode' => TRUE,
			'productionMode' => FALSE,
			'consoleMode' => FALSE,
			'tempDir' => 'C:\xampp\htdocs\lekaren\app/../temp',
		]);
	}
	...
	{
		$service = new Nette\Application\PresenterFactory(new Nette\Bridges\ApplicationDI\PresenterFactoryCallback($this, 5, 'C:\xampp\htdocs\lekaren\app/../temp/cache/Nette%5CBridges%5CApplicationDI%5CApplicationExtension'));
	...
	{
		$service = new Nette\Caching\Storages\SQLiteJournal('C:\xampp\htdocs\lekaren\app/../temp/cache/journal.s3db');
		return $service;
	}
	...
	{
		$service = new Nette\Caching\Storages\FileStorage('C:\xampp\htdocs\lekaren\app/../temp/cache',
	...
	{
		$service = new Nette\Database\Connection('mysql:host=127.0.0.1;dbname=lekaren', 'root',
			NULL, ['lazy' => TRUE]);
	...
	{
		return new Container_dcfc5f180f_Nette_Bridges_ApplicationLatte_ILatteFactoryImpl_latte_latteFactory($this);
	}
...
class Container_dcfc5f180f_Nette_Bridges_ApplicationLatte_ILatteFactoryImpl_latte_latteFactory implements Nette\Bridges\ApplicationLatte\ILatteFactory
{
	private $container;


	public function __construct(Container_dcfc5f180f $container)
	{
	...
	public function create()
	{
		...
		$service->setTempDirectory('C:\xampp\htdocs\lekaren\app/../temp/cache/latte');
