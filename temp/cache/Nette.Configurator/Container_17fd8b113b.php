<?php
// source: C:\xampp\htdocs\iis\lekaren\app/config/config.neon 
// source: C:\xampp\htdocs\iis\lekaren\app/config/config.local.neon 

class Container_17fd8b113b extends Nette\DI\Container
{
	protected $meta = [
		'types' => [
	...
	{
		parent::__construct([
			'appDir' => 'C:\xampp\htdocs\iis\lekaren\app',
			'wwwDir' => 'C:\xampp\htdocs\iis\lekaren\www',
			'debugMode' => TRUE,
			'productionMode' => FALSE,
			'consoleMode' => FALSE,
			'tempDir' => 'C:\xampp\htdocs\iis\lekaren\app/../temp',
		]);
	}
	...
	{
		$service = new Nette\Application\PresenterFactory(new Nette\Bridges\ApplicationDI\PresenterFactoryCallback($this, 5, 'C:\xampp\htdocs\iis\lekaren\app/../temp/cache/Nette%5CBridges%5CApplicationDI%5CApplicationExtension'));
	...
	{
		$service = new Nette\Caching\Storages\SQLiteJournal('C:\xampp\htdocs\iis\lekaren\app/../temp/cache/journal.s3db');
		return $service;
	}
	...
	{
		$service = new Nette\Caching\Storages\FileStorage('C:\xampp\htdocs\iis\lekaren\app/../temp/cache',
	...
	{
		return new Container_17fd8b113b_Nette_Bridges_ApplicationLatte_ILatteFactoryImpl_latte_latteFactory($this);
	}
...
class Container_17fd8b113b_Nette_Bridges_ApplicationLatte_ILatteFactoryImpl_latte_latteFactory implements Nette\Bridges\ApplicationLatte\ILatteFactory
{
	private $container;


	public function __construct(Container_17fd8b113b $container)
	{
	...
	public function create()
	{
		...
		$service->setTempDirectory('C:\xampp\htdocs\iis\lekaren\app/../temp/cache/latte');
